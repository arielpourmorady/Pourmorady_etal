...
files <- list.files(path = "matrix.zonal_omp.ORs.and.GIs.nonX.L1.ORs.and.GIs.nonX.L2.pd",
                    "*.20k.1.clean.ORs.and.GIs.nonX.L1.ORs.and.GIs.nonX.L2.pd.txt",
                    full.names = TRUE,
                    recursive = FALSE)
...
distance_from_active_allele_dataframe_MOR28_mut <- distance_from_active_allele_dataframe_MOR28 %>%
...
distance_from_active_allele_dataframe_mut <- rbind(distance_from_active_allele_dataframe_MOR28_mut, 
...
distance_from_active_allele_dataframe_mut_MOR28 <- distance_from_active_allele_dataframe_mut %>% filter(geno == 'MOR28')
...
distance_from_active_allele_dataframe_mut <- rbind(distance_from_active_allele_dataframe_mut_MOR28, distance_from_active_allele_dataframe_mut_zonal_OMP)
...
write.table(supplementary_file, file = '/media/storageE/ariel/R/finalpaper_August2023/dipc/dipc.ptII.enhancer.preferences/SuppFig5b_MOR28_GIsInHub.txt', 
            sep = '\t', col.names = TRUE)
