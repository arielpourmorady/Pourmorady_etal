...
setwd("/media/storageE/ariel/R/finalpaper_August2023/dipc/dipc.ptIX.tanPCAandGIHsize/") 
...
cpg_tan <- rbind(tan_adult_cpg, tan_newborn_cpg) %>%
  ...
  reshape2::dcast(cell ~ loc, value.var = "cpg")
...
write.table(df_coordinates, file = "/media/storageE/ariel/R/finalpaper_August2023/dipc/dipc.ptIX.tanPCAandGIHsize/SuppFig8e_DipCPCA.txt", sep = '\t')
...
islands_percell_dataframe <- read.table("islands_percell_dataframe.txt",sep = "\t") 
...
write.table(df_coordinates_grouped_sd, file = "/media/storageE/ariel/R/finalpaper_August2023/dipc/dipc.ptIX.tanPCAandGIHsize/SuppFig8f_DipCPCAHubs.txt", sep = '\t')
