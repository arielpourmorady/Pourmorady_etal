...
enhancer_to_enhancer.gg8.p2.ctrl.r1 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.ctrl.r1", "trans", "square") %>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.5m.r1 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.5m.r1", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.30m.r1 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.30m.r1", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.60m.r1 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.60m.r1", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)

enhancer_to_enhancer.gg8.p2.r1 <- as.data.frame(rbind(enhancer_to_enhancer.gg8.p2.ctrl.r1, 
                                                   enhancer_to_enhancer.gg8.p2.5m.r1,
                                                   enhancer_to_enhancer.gg8.p2.30m.r1,
                                                   enhancer_to_enhancer.gg8.p2.60m.r1)) %>%
  mutate(specificity = norm - enhancer_to_enhancer.gg8.p2.ctrl.r1$norm) %>%
  mutate(specificity = 100*specificity/enhancer_to_enhancer.gg8.p2.ctrl.r1$norm) %>% 
  select(norm, specificity)
enhancer_to_enhancer.gg8.p2.r1$type <- "islands"
enhancer_to_enhancer.gg8.p2.r1$time <- c(0, 5, 30, 60)
...
enhancer.gg8.p2.r1 <- rbind(enhancer_to_enhancer.gg8.p2.r1, activeP2_to_enhancer.gg8.p2.r1, inactiveP2_to_enhancer.gg8.p2.r1)

# Rep 2

enhancer_to_enhancer.gg8.p2.ctrl.r2 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.ctrl.r2", "trans", "square") %>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.5m.r2 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.5m.r2", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.30m.r2 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.30m.r2", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.60m.r2 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.60m.r2", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)

enhancer_to_enhancer.gg8.p2.r2 <- as.data.frame(rbind(enhancer_to_enhancer.gg8.p2.ctrl.r2, 
                                                      enhancer_to_enhancer.gg8.p2.5m.r2,
                                                      enhancer_to_enhancer.gg8.p2.30m.r2,
                                                      enhancer_to_enhancer.gg8.p2.60m.r2)) %>%
  mutate(specificity = norm - enhancer_to_enhancer.gg8.p2.ctrl.r2$norm) %>%
  mutate(specificity = 100*specificity/enhancer_to_enhancer.gg8.p2.ctrl.r2$norm) %>% 
  select(norm, specificity)
enhancer_to_enhancer.gg8.p2.r2$type <- "islands"
enhancer_to_enhancer.gg8.p2.r2$time <- c(0, 5, 30, 60)
...
enhancer.gg8.p2.r2 <- rbind(enhancer_to_enhancer.gg8.p2.r2, activeP2_to_enhancer.gg8.p2.r2, inactiveP2_to_enhancer.gg8.p2.r2)

# Rep 3

enhancer_to_enhancer.gg8.p2.ctrl.r3 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.ctrl.r3", "trans", "square") %>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.5m.r3 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.5m.r3", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.30m.r3 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.30m.r3", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)
enhancer_to_enhancer.gg8.p2.60m.r3 <- enhancer_to_enhancer_matrix(hic_contacts, "gg8.p2.60m.r3", "trans", "square")%>%
  filter(bait_order == 20, prey_order == 20)

enhancer_to_enhancer.gg8.p2.r3 <- as.data.frame(rbind(enhancer_to_enhancer.gg8.p2.ctrl.r3, 
                                                      enhancer_to_enhancer.gg8.p2.5m.r3,
                                                      enhancer_to_enhancer.gg8.p2.30m.r3,
                                                      enhancer_to_enhancer.gg8.p2.60m.r3)) %>%
  mutate(specificity = norm - enhancer_to_enhancer.gg8.p2.ctrl.r3$norm) %>%
  mutate(specificity = 100*specificity/enhancer_to_enhancer.gg8.p2.ctrl.r3$norm) %>% 
  select(norm, specificity)
enhancer_to_enhancer.gg8.p2.r3$type <- "islands"
enhancer_to_enhancer.gg8.p2.r3$time <- c(0, 5, 30, 60)
...
enhancer.gg8.p2.r3 <- rbind(enhancer_to_enhancer.gg8.p2.r3, activeP2_to_enhancer.gg8.p2.r3, inactiveP2_to_enhancer.gg8.p2.r3)
...
b <- ggplot(enhancer.gg8.p2_mean_se_lineplot, aes(x = time, y = mean, colour = type)) + geom_line() +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=4, position=pd, colour="black") + 
  geom_line(position=pd, size = 0.75) +
  geom_point(position=pd, size = 2.5) + 
  scale_colour_manual(values=c("#409b73", "#b10101", "#012db1")) +
  ggtitle("% Decrease in trans Contacts \n square Norm") + 
  theme_classic()

b

ggsave(file="/media/storageE/ariel/R/finalpaper/liquid.hic.heatmaps.replicates/percent_decrease_in_contact_specificity_trans_square.pdf", b)

enhancer.gg8.p2_mean_se_barplot <- enhancer.gg8.p2_mean_se_lineplot
enhancer.gg8.p2_mean_se_barplot$time <- as.character(enhancer.gg8.p2_mean_se_barplot$time)
enhancer.gg8.p2_mean_se_barplot <- enhancer.gg8.p2_mean_se_barplot %>% 
  filter(time != "0") %>%
 # filter(type != "islands") %>%
  mutate(time=factor(time, levels=time)) %>%
  mutate(type=factor(type, levels=c("inactive OR", "active OR", "islands")))


a <- ggplot(enhancer.gg8.p2_mean_se_barplot, aes(x = time, y = mean, fill = type)) + geom_bar(stat = 'identity', position = 'dodge', width = 0.9, colour = "black") +
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=0.2, position = position_dodge(width = 0.9), colour="black") + 
  scale_fill_manual(values=c("#b10101", "#409b73", "#012db1")) +
