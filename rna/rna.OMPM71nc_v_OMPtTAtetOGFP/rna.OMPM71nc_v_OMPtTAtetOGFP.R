...
setwd("/media/storageE/ariel/R/finalpaper_August2023/rna/rna.OMPM71nc_v_OMPtTAtetOGFP/") 
...
dds$condition <- factor(dds$condition, levels=c('OMPtTA_tetOGFP',
                                                'OMPtTA_tetOM71_KO'))
...
resLFC_d$comparison <- "OMPtTA_tetOM71_KO vs. OMPtTA_tetOGFP"
write.table(resLFC_d, file = "SuppFig10g_MAPlot.txt")
