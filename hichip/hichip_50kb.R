...
a <- pheatmap(activeP2_to_enhancer_matrix.gg8tta.tetop2.h27ac.HiChIP.IP[16:24,16:24], 
              cluster_rows=FALSE, 
              cluster_cols=FALSE, 
              border_color = NA,
              show_rownames = FALSE,
...
b <- pheatmap(activeP2_to_enhancer_matrix.gg8tta.tetop2.h27ac.HiChIP.input[16:24,16:24], 
              cluster_rows=FALSE, 
              cluster_cols=FALSE, 
              border_color = NA,
              show_rownames = FALSE,
...
g <- pheatmap(inactiveP2_to_enhancer_matrix.gg8tta.tetop2.h27ac.HiChIP.IP[16:24,16:24], 
              cluster_rows=FALSE, 
              cluster_cols=FALSE, 
              border_color = NA,
              show_rownames = FALSE,
...
h <- pheatmap(inactiveP2_to_enhancer_matrix.gg8tta.tetop2.h27ac.HiChIP.input[16:24,16:24], 
              cluster_rows=FALSE, 
              cluster_cols=FALSE, 
              border_color = NA,
              show_rownames = FALSE,
...
df <- hic_contacts %>% filter(bait %in% P2_cluster_df$loc) %>%
  filter(prey %in% Islands_50kb$prey) %>% 
...
island_to_island_hichip <- hic_contacts %>%
  filter(bait %in% Islands_50kb$prey, 
         prey %in% Islands_50kb$prey, 
         arch == "trans", 
         bait != prey,
...
# }
# 
# hic_contacts %>% filter(bait %in% Islands_50kb$prey) %>%
#   filter(prey )
# 
# 
